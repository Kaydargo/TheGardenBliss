...
include('includes/functions.php');
    $queryPlant = "SELECT * FROM plant WHERE type = 'vegetable' "; 
...
table {
  ...
  $( function() {
    ...
    // Let the garden be droppable, accepting the gallery items
    $garden.droppable({
      accept: "#gallery > li",
      classes: {
        "ui-droppable-active": "ui-state-highlight"
...
<?php foreach ($vegGardens as $vegGarden): ?>
    ...
    <?= ($vegGarden['plantIcon'] <> " " ? "<img id='{$vegGarden['plantID']}'  style='width:96px; height:72px; margin-top:10px;' src='images/{$vegGarden['plantIcon']}'/>" : "") ?>
...
<div id="garden" class="ui-widget-content ui-state-default">
  <h4 class="ui-widget-header"><span class="ui-icon">Garden</span> Garden</h4>
  <table>
  <tr>
  <td>
   <td>
